(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ABC = factory());
  ...
  //
  var script = {
    // 由于这里这里填name打包时会报'core-js/modules/es.function.name' is imported by source\publish\index.js, but could not be resolved – treating it as an external dependency
    // 猜测可能是重名了，因此换了一个
    // $name:"MyButton"
    // 安装了core-js,好像能用.name了
    name: "MyButton"
  };
  ...
  __vue_render__._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__ = "data-v-7e785c34";
    /* module identifier */
  ...
  */
  var _export$1 = function (options, source) {
    ...
    for (key in source) {
      ...
      if (options.bind && USE_NATIVE) resultProperty = functionBindContext(sourceProperty, global_1$1);
  ...
  _export$1({ global: true, bind: true, forced: MSIE }, {
    ...
    setTimeout: wrap(global_1$1.setTimeout),
    // `setInterval` method
    // https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-setinterval
    setInterval: wrap(global_1$1.setInterval)
  });
  ...
  var script$2 = {
    ...
    methods: {
      run: function run() {
        ...
        this.timer = setInterval$1(function () {
          second--;
          _this.text = _this.getText(second);
          second <= 0 && _this.stop();
        }, 1000);
      },
      stop: function stop() {
      ...
      getText: function getText(second) {
  ...
  __vue_render__$2._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$2 = "data-v-49456de0";
    /* module identifier */
  ...
  var components = /*#__PURE__*/Object.freeze({
    ...
    buttonGroup: __vue_component__$1,
    sendcode: __vue_component__$2
  });
